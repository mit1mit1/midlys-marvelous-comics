...
export default {
    props: {
        ...
        limbPositions: {
            default: availableLimbPositions.handsDown,
        },
    },
    data() {
        const headX = this.minimumX + this.lengthX / 10;
        const headY = this.minimumY;
        ...
        const { rightArmPosition, leftArmPosition, rightLegPosition, leftLegPosition } = this.limbPositions;
